...
import Binder = android.os.Binder;
  ...
  namespace android {
    export namespace vending {
      export namespace billing {
         ...
         */
        export interface IInAppBillingService {
          /**
           ...
           */
          isBillingSupported(apiVersion: number, packageName: string, type: string): number;
           ...
           */
          getSkuDetails(apiVersion: number, packageName: string, type: string, skusBundle: Bundle): Bundle;
           ...
           */
          getPurchases(apiVersion: number, packageName: string, type: string, continuationToken: string): Bundle;
           ...
           */
          consumePurchase(apiVersion: number, packageName: string, purchaseToken: string): number;

          /**
           * This API is currently under development.
           */
          stub(apiVersion: number, packageName: string, type: string): number;
        ...
        export namespace IInAppBillingService {
          export abstract class Stub extends Binder /*implements IInAppBillingService*/ {
            /**
             ...
             */
            public static asInterface(obj: IBinder): IInAppBillingService;

            public asBinder(): IBinder;

            public onTransact(code: number, data: Parcel, reply: Parcel, flags: number): boolean;
          }
        }
      }
    }
